    ...
    <div className="min-h-screen bg-white text-gray-900" style={{ 
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-blue-50 overflow-hidden animate-gradient">
        ...
        <div className="absolute inset-0">
          ...
          <div className="floating-element absolute bottom-20 right-20 w-80 h-80 bg-blue-200/20 rounded-full blur-2xl"></div>
      ...
      {/* Features Section - Azul Profissional COM EFEITOS */}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card-3d bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 animate-fade-in-up">
              <div className="w-16 h-16 bg-blue-100 rounded-2xl flex items-center justify-center mb-6 animate-float">
            ...
            <div className="card-3d bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 animate-fade-in-up">
              <div className="w-16 h-16 bg-green-100 rounded-2xl flex items-center justify-center mb-6 animate-float">
                <div className="text-2xl"></div>
              </div>
      ...
      {/* App Demo Section - Azul Profissional COM EFEITOS */}
      ...
      {/* Pricing Section - Azul Profissional COM EFEITOS */}
      <section id="plans" className="py-20 bg-blue-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 animate-fade-in-up">
            <h3 className="text-3xl md:text-4xl font-bold text-blue-900 mb-4">Escolha seu plano</h3>
            <p className="text-xl text-blue-700 max-w-3xl mx-auto">Planos flexíveis para todos os perfis</p>
          </div>
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="card-3d bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 animate-scale-in">
              <div className="text-center mb-8">
                <h4 className="text-2xl font-bold text-blue-900 mb-2">Plano Mensal</h4>
                <div className="text-4xl font-bold text-blue-600 mb-2">
                  R$ {appConfig.plan_price_monthly}
                </div>
                <p className="text-blue-700">por mês</p>
              </div>
            ...
            <div className="card-3d bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-blue-500 animate-scale-in">
              <div className="text-center mb-8">
                <div className="inline-block bg-blue-600 text-white px-3 py-1 rounded-full text-sm font-semibold mb-4 animate-pulse-glow">
                  Mais vantajoso
                </div>
                <h4 className="text-2xl font-bold text-blue-900 mb-2">Plano Anual</h4>
                <div className="text-4xl font-bold text-blue-600 mb-2">
                  R$ {appConfig.plan_price_annual}
                </div>
                <p className="text-blue-700">por ano</p>
              </div>
              <ul className="space-y-4 mb-8">
      ...
      {/* Testimonials Section - Azul Profissional COM EFEITOS */}
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 animate-fade-in-up">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card-3d bg-gray-50 rounded-2xl p-8 shadow-lg hover-lift animate-fade-in-up">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mr-4 animate-float">
      ...
      {/* Final CTA Section - Azul Profissional COM EFEITOS */}
      <section className="py-20 bg-gray-50">
