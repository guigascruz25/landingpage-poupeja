      ...
      <section id="plans" className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            {/* Plano Anual */}
            <div className="card-3d bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-blue-200 animate-scale-in">
              <div className="text-center mb-8">
                <div className="inline-block bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-semibold mb-4 animate-pulse-glow">
                  Mais Popular
                </div>
